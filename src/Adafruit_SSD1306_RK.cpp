...
Adafruit_SSD1306::Adafruit_SSD1306(size_t width, size_t height, int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS) : Adafruit_GFX(width, height), _width(width), _height(height) {
  cs = CS;
  rst = RST;
  dc = DC;
  sclk = SCLK;
...
Adafruit_SSD1306::Adafruit_SSD1306(size_t width, size_t height, int8_t DC, int8_t RST, int8_t CS) : Adafruit_GFX(width, height), _width(width), _height(height) {
  dc = DC;
  rst = RST;
  cs = CS;
  hwSPI = true;
